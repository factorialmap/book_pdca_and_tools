...
Na filosofia dos 5S no Japão, a aplicação do seiri obedece a uma ordem de classificação.
 ...
 a) objetos desnecessários: coisas que não são utilizadas (ferramentas avariadas, moldes, materiais fora de linha, peças e materiais não conformes, equipamentos antigos ou em desuso)
 
 b)	objetos não essenciais: coisas necessárias, porém, não são utilizadas com muita frequência
 
 c)	objetos essenciais: coisas necessárias e que são utilizadas frequentemente.
